...
const descriptions = {
    ...
    'oppo-market': 'The official application marketplace for OPPO, OnePlus, and Realme devices powered by ColorOS, OxygenOS, and Realme UI.',
    ...
    'chrome-web-store': 'The premier marketplace for Google Chrome and Chromium browser extensions, serving billions of users worldwide.',
    'edge-addons': 'Microsoft\'s official store for Chromium-based extensions designed for Microsoft Edge, delivering seamless Windows and enterprise reach.',
    'firefox-addons': 'Mozilla\'s official repository for Firefox extensions, themes, and dictionaries built on the open WebExtensions standard.',
    'opera-addons': 'The official extension catalog for the Opera browser family, including Opera One and the dedicated gaming browser, Opera GX.',
    'safari-extensions': 'Apple\'s official marketplace for Safari Web Extensions across macOS, iOS, iPadOS, and visionOS.',
    'greasy-fork': 'The premier global repository for user scripts running on Tampermonkey, Violentmonkey, and Greasemonkey.',
    'openuserjs': 'An open-source, community-driven user script repository with collaborative editing and GitHub integration.',
    'naver-whale': 'The official extension marketplace for Naver Whale browser across desktop, mobile, and Whale OS.',
