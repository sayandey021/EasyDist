                ...
                <Card className="border-none shadow-md hover:shadow-lg transition-shadow duration-300 group">
                    ...
                    <CardContent className="space-y-4">
                        <Button variant="outline" className="w-full justify-between hover:border-teal-500 hover:text-teal-600 group/btn" asChild>
                            <a href="https://store.whale.naver.com/" target="_blank" rel="noreferrer">
                                Whale Store Home
                                <ExternalLink className="h-4 w-4 opacity-50 group-hover/btn:opacity-100" />
                            </a>
                        </Button>
                        <Button variant="outline" className="w-full justify-between hover:border-teal-500 hover:text-teal-600 group/btn" asChild>
                            <a href="https://developers.whale.naver.com/" target="_blank" rel="noreferrer">
                                Whale Developers Center
                                <ExternalLink className="h-4 w-4 opacity-50 group-hover/btn:opacity-100" />
                            </a>
                        </Button>
                        <Button variant="outline" className="w-full justify-between hover:border-teal-500 hover:text-teal-600 group/btn" asChild>
                            <a href="https://whale.naver.com/" target="_blank" rel="noreferrer">
                                Naver Whale Browser
                                <ExternalLink className="h-4 w-4 opacity-50 group-hover/btn:opacity-100" />
                            </a>
                        </Button>
