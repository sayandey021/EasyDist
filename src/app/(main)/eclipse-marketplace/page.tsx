    ...
    return (
        <div className="flex flex-col gap-6 w-full animate-in fade-in slide-in-from-bottom-4 duration-300 ease-in-out">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card className="md:col-span-2 border-none bg-indigo-500/5 hover:bg-indigo-500/10 transition-colors duration-300">
                    <CardHeader>
                ...
                <Card className="border-none shadow-md hover:shadow-lg transition-shadow duration-300 group">
                    ...
                    <CardContent className="space-y-4">
                        <Button variant="outline" className="w-full justify-between hover:border-indigo-500 hover:text-indigo-600 group/btn" asChild>
                            <a href="https://marketplace.eclipse.org/" target="_blank" rel="noreferrer">
                                Eclipse Marketplace Home
                                <ExternalLink className="h-4 w-4 opacity-50 group-hover/btn:opacity-100" />
                            </a>
                        </Button>
                        <Button variant="outline" className="w-full justify-between hover:border-indigo-500 hover:text-indigo-600 group/btn" asChild>
                            <a href="https://marketplace.eclipse.org/content/add-content" target="_blank" rel="noreferrer">
                                Submitting Content Guide
                                <ExternalLink className="h-4 w-4 opacity-50 group-hover/btn:opacity-100" />
                            </a>
                        </Button>
                        <Button variant="outline" className="w-full justify-between hover:border-indigo-500 hover:text-indigo-600 group/btn" asChild>
                            <a href="https://help.eclipse.org/" target="_blank" rel="noreferrer">
