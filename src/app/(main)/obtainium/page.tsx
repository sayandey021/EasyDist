    ...
    <div className="flex flex-col gap-6 w-full max-w-6xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-300 ease-in-out">
      <div className="flex flex-col gap-2">
        <div className="flex items-center gap-3">
          <PlatformLogo platformName="Obtainium" className="h-10 w-10" />
        ...
        <p className="text-muted-foreground text-lg max-w-2xl">
          Generate app links and track apps directly from their source with Obtainium.
        </p>
      </div>
          ...
          <Card className="lg:col-span-2 border-none bg-orange-500/5 hover:bg-orange-500/10 transition-colors duration-300">
              ...
              <CardContent className="space-y-4">
                  <p className="text-sm text-muted-foreground leading-relaxed">
                      Obtainium allows you to install and update Android apps directly from their releases pages (e.g. GitHub, GitLab, F-Droid, IzzyOnDroid, and many others) without needing a centralized app store.
                  </p>
                  
                  <div className="flex flex-wrap gap-2 mt-4">
                      <Badge variant="secondary" className="bg-orange-500/10 text-orange-500">Direct Tracking</Badge>
                      <Badge variant="secondary" className="bg-orange-500/10 text-orange-500">FOSS</Badge>
                      <Badge variant="secondary" className="bg-orange-500/10 text-orange-500">Android</Badge>
                  </div>
              </CardContent>
          </Card>
          ...
          <Card className="border-none shadow-md hover:shadow-lg transition-shadow duration-300 group">
              ...
              <CardContent className="space-y-4">
                  <Button variant="outline" className="w-full justify-between hover:border-orange-500 hover:text-orange-500 group/btn h-auto min-h-10 py-2.5 px-3.5 whitespace-normal" asChild>
                            <a href="https://github.com/ImranR98/Obtainium" target="_blank" rel="noreferrer" className="flex items-center justify-between w-full gap-2">
                  ...
                  <Button variant="outline" className="w-full justify-between hover:border-orange-500 hover:text-orange-500 group/btn h-auto min-h-10 py-2.5 px-3.5 whitespace-normal" asChild>
                            <a href="https://github.com/ImranR98/Obtainium/wiki" target="_blank" rel="noreferrer" className="flex items-center justify-between w-full gap-2">
