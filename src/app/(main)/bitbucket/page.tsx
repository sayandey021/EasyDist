        ...
        <div className="flex flex-col gap-6 w-full animate-in fade-in slide-in-from-bottom-4 duration-300 ease-in-out">
            <div className="flex flex-col gap-2">
                <div className="flex items-center gap-3">
                    <PlatformLogo platformName="Bitbucket" className="h-10 w-10" />
                    <h1 className="text-3xl font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-500">
                        Bitbucket
                    </h1>
                </div>
                <p className="text-muted-foreground text-lg max-w-2xl">
                    Git solution for professional teams by Atlassian
                </p>
            </div>
                ...
                <Card className="md:col-span-2 border-none bg-blue-500/5 hover:bg-blue-500/10 transition-colors duration-300">
                    ...
                    <CardContent className="space-y-4">
                        <p className="text-sm text-muted-foreground leading-relaxed">
                            A Git-based source code repository hosting service. It provides excellent integration with Jira and Trello, catering strongly to professional teams and enterprise workflows.
                        </p>
                        <p className="text-sm text-muted-foreground leading-relaxed">
                            A Git-based source code repository hosting service. It provides excellent integration with Jira and Trello, catering strongly to professional teams and enterprise workflows.
                        </p>
                        ...
                        <div className="flex flex-wrap gap-2">
                            ...
                            <Badge variant="secondary" className="bg-blue-500/10 text-blue-500">Atlassian</Badge>
                        </div>
                    </CardContent>
                </Card>
                ...
                <Card className="border-border/50 hover:border-blue-500/50 transition-colors duration-300">
                    ...
                    <CardContent className="space-y-6">
                        ...
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <h3 className="font-semibold text-green-700 dark:text-green-300">Jira Integration!</h3>
                        </div>
                        <p className="text-sm text-green-600 dark:text-green-400">
                            Bitbucket offers deep integration with Jira and Trello for seamless project management.
                        </p>
                    </div>
                    ...
                    <div className="rounded-lg bg-muted/50 p-4">
                        ...
                        <p className="text-sm text-muted-foreground">
                            <strong>Free Tier:</strong> Up to 5 users, 50 build minutes/month, 1GB LFS.
                        </p>
                        <p className="text-sm text-muted-foreground mt-1">
                            <strong>Standard:</strong> $3/user/month for unlimited users and more build minutes.
                        </p>
                    </div>
                        ...
                        <ol className="space-y-4">
                            <li className="flex gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-muted-foreground">Setup your workspace and create repositories.</p>
                                </div>
                            </li>
                            <li className="flex gap-3">
                                <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-primary text-primary-foreground text-sm font-bold">2</span>
                                <div>
                                    <p className="font-medium">Bitbucket Pipelines</p>
                                    <p className="text-sm text-muted-foreground">Use bitbucket-pipelines.yml to build and test your software.</p>
                                </div>
                            </li>
                            <li className="flex gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-muted-foreground">Publish artifacts to the Downloads section of your repository.</p>
                                </div>
                            </li>
                        </ol>
                    </div>
