            ...
            <Card>
                <CardHeader>
                    <div className="flex items-center justify-between">
                        <div>
                            <CardTitle className="text-2xl">Amazon Appstore</CardTitle>
                            <CardDescription>
                ...
                <CardContent className="space-y-8">
                    ...
                    <div className="flex gap-4">
                        <Button asChild>
                            <Link href="https://developer.amazon.com/apps-and-games/console/apps" target="_blank">
                                <ExternalLink className="mr-2 h-4 w-4" />
                                Amazon Developer Console
                            </Link>
                        </Button>
                        <Button variant="outline" asChild>
                            <Link href="https://developer.amazon.com/docs/app-submission/submitting-apps-to-amazon-appstore.html" target="_blank">
                                <ExternalLink className="mr-2 h-4 w-4" />
                                Documentation
                            </Link>
                        </Button>
